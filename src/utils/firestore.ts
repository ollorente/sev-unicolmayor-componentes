...
export const fsGet = async (table: string, id: string) => {
  try {
...
export const fsRemove = async (table: string, id: string) => {
  try {
...
export const fsUpdate = async (table: string, id: string, data: any) => {
  try {
